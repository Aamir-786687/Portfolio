  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 p-4 sm:p-6 md:p-10 min-h-screen bg-white">
      ...
      <div className="max-w-md text-black space-y-4 text-center md:text-left">
        ...
        <div>
          <p className="text-lg sm:text-xl font-bold">+91 70 65 25 26 43</p>
          <p className="text-gray-700 text-sm sm:text-base">aamir557ahmad@gmail.com</p>
        </div>
      ...
      >
        <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">ANY PROJECT?</h3>
        ...
        <input
          ...
          required
          className="w-full mb-3 sm:mb-4 p-2 sm:p-3 rounded-md bg-white bg-opacity-20 text-black placeholder-black outline-none text-sm sm:text-base"
        />
        ...
        <textarea
          ...
          rows="4"
          required
          className="w-full mb-4 sm:mb-6 p-2 sm:p-3 rounded-md bg-white bg-opacity-20 text-black placeholder-black outline-none resize-none text-sm sm:text-base"
        ></textarea>

        <button
          type="submit"
          className="w-full sm:w-auto bg-black text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full font-semibold flex items-center justify-center gap-2 group transition-all duration-300 hover:bg-white hover:text-black hover:scale-105"
        >
          SUBMIT NOW
