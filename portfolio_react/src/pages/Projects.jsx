          ...
          <div className="grid grid-cols-1 md:grid-cols-1 justify-center lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16">
            {projects.map((project) => (
               ...
               >
                   ...
                   alt={project.title}
                   className="w-full h-48 sm:h-56 md:h-80 lg:h-64 object-cover"
                 />
                                 <div className="p-3 sm:p-4 md:p-8 lg:p-6">
                                     <h3 className="text-base sm:text-lg md:text-2xl lg:text-xl font-semibold mb-2">{project.title}</h3>
                  <p className="text-xs sm:text-sm text-gray-600 mb-2">{project.days}</p>
                                     <p className="text-xs sm:text-sm md:text-base lg:text-sm text-gray-700 mb-3 sm:mb-4 leading-relaxed">{project.description}</p>
                                     <p className="text-xs sm:text-sm md:text-base lg:text-sm text-gray-500 mb-3 sm:mb-4">
